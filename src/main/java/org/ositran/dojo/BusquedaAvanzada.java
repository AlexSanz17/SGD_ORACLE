...
public class BusquedaAvanzada {
   ...
   private String documentoIdentidadConcesionario;
   ...
   private String nroHT;
   private String nroRS;
   ...
   public String getNumeroLegajo() {
    ...
    public String getNroHT() {
        return nroHT;
    }

    public void setNroHT(String nroHT) {
        this.nroHT = nroHT;
    }

    public String getNroRS() {
        return nroRS;
    }

    public void setNroRS(String nroRS) {
        this.nroRS = nroRS;
    }
   ...
   public String getDocumentoIdentidadConcesionario() {
      return documentoIdentidadConcesionario;
   }

   public void setDocumentoIdentidadConcesionario(String documentoIdentidadConcesionario) {
      this.documentoIdentidadConcesionario = documentoIdentidadConcesionario;
   }
