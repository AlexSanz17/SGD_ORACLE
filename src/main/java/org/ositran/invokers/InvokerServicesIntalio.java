 ...
 * @author ANGEL
 */
public class InvokerServicesIntalio {
    //Atributos
    ...
    private static Logger logger=Logger.getLogger(InvokerServicesIntalio.class);
    
    //Constructor
    public InvokerServicesIntalio() {
    
    }
    
    //Metodos
    public void setValue(String soapRequest){
        //Falta rellenar codigo
        try{
            objStringBuffer.append(soapRequest);
        }catch(Exception e){
            strDemo=""+e.getMessage();
        }
    }
    ...
    public void setRequest(String strUrl,String strService, String soapRequest){
        //Falta rellenar codigo
        address = strUrl;
        soapAction = strService;
        fileName = soapRequest; 
    }
