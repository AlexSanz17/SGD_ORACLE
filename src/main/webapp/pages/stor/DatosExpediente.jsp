   ...
   <head>
      ...
      <script type="text/javascript">
        ...
        dojo.require("dijit.ProgressBar");
         ...
         var storeMotivos = new dojo.data.ItemFileReadStore({url: "listaMotivos.action"});
      </script>
                           ...
                           <table width="100%" align="center" border="0">
                              ...
                              <tr>
                                 ...
                                 <td align="left" width="17%" class="label">
                                    ...
                                    <s:property value="documentoStor.documento.numeroDocumento" />
                                 </td>
                                 <td align="left" >&nbsp;</td>
                                 <td align="left" width="45%" class="label"></td>
                                 <td></td>
                              ...
                              <tr>
                                 ...
                                 <td align="left" width="17%" class="label">
                                    ...
                                    <s:property value="documentoStor.documento.numeroFolios" />
                                 </td>
                                 <td align="left" >&nbsp;</td>
                                 <td align="left" width="45%" class="label"></td>
                                 <td></td>
                              ...
                              <tr>
                                 ...
                                 <td colspan="3" align="left" class="label">
                                    <!--<input name="representantelegal" type="text" class="cajaMontoTotal" value="<s:property value="expediente.getCliente().getRepresentantelegal()" />" size="50" readonly>-->
                                    <!--<s:property value="expediente.cliente.representanteLegal" />-->
                              ...
                              <tr>
                                 ...
                                 <td colspan="3" align="left" class="label">
                                    <!--<input name="direccion" type="text" class="cajaMontoTotal" value="<s:property value="expediente.cliente.direccionPrincipal" />" size="50" readonly>-->
                                    <!--<s:property value="expediente.cliente.direccionPrincipal" />-->
                              ...
                              <tr>
                                 ...
                                 <td colspan="3" align="left" class="label">
                                    <!--<input name="direccionprocesal" type="text" class="cajaMontoTotal" value="<s:property value="expediente.getCliente().getDireccionalternativa()" />" size="50" readonly>-->
                                    <!--<s:property value="expediente.cliente.direccionAlternativa" />-->
                              ...
                              <tr>
                                 ...
                                 <td colspan="3" align="left" class="label">
                                    <!--<input name="telefono" type="text" class="cajaMontoTotal" value="<s:property value="expediente.getCliente().getTelefono()" />" size="20" readonly>-->
                              ...
                              <tr>
                                 ...
                                 <td colspan="3" align="left" class="label">
                                    <!--<input name="correo" type="text" class="cajaMontoTotal" value="<s:property value="expediente.getCliente().getCorreo()" />" size="50" readonly>-->
                              ...
                              <tr>
                                 ...
                                 <td height="16" align="left">Nombre/Raz&oacute;n Social</td>
                                 <td colspan="3" align="left" class="label">
                                    <!--<input name="nombreconcesionario" type="text" class="cajaMontoTotal" value="<s:property value="expediente.concesionario.razonSocial" />" size="30" readonly>-->
                              ...
                              <tr>
                                 ...
                                 <td height="16" align="left">Direcci&oacute;n</td>
                                 <td colspan="3" align="left" class="label">
                                    <!--<input name="direccionconcesionario" type="text" class="cajaMontoTotal" value="<s:property value="expediente.getConcesionario().getDireccion()" />" size="30" readonly>-->
                              ...
                              <tr>
                                 ...
                                 <td height="16" align="left">Correo Electr&oacute;nico</td>
                                 <td colspan="3" align="left" class="label">
                                    <!--<input name="correoconcesionario" type="text" class="cajaMontoTotal" value="<s:property value="expediente.getConcesionario().getCorreo()" />" size="30" readonly>-->
