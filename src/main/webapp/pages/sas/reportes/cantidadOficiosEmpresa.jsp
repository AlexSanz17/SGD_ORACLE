...
function buscar(){
	f = document.cantidadOficEmpForm;
...
<form name="cantidadOficEmpForm" action="doCantOfiEmpr_buscar.action" method="post">
<table width="100%" id="todo">
  ...
  <tr>
		<td height="20"colspan="3" class="titulo">
            ...
            <td align="left" class="titulo">Cantidad de oficios por empresa</td>
					</tr>
				</table>
		</td>
	</tr>
  ...
  <tr align="center"> 
    <td width="1%" align="center">&nbsp;</td>
      <td width="99%" colspan="2" align="left"> <img onClick="javascript:buscar()" src="images/buscar.bmp" border="0" alt="Buscar"/> 
        ...
        &nbsp;&nbsp; <img src="images/excel.bmp" border="0" onClick="location.href='reporte18.xls'" target="_blank" alt=""/>&nbsp;&nbsp; 
    </tr>
  <tr> 
    <td colspan="3"> 
        ...
        <tr> 
          <td height="45"> 
                ...
                <tr> 
                 ...
                 <tr> 
                  ...
                  <td align="left" class="label">
					<input class="cajaMontoTotal" name="fechaDesde" type="text" id="campo_fecha2" size="14" maxlength="10" value="<s:property value='fechaDesde'/>"> 
                    <input alt="Calendario" class="cajaFecha" id="lanzador2" value="..." type="button"></td>
                  <td align="left" >Fecha Hasta</td>
                  <td align="left" class="label">
					<input class="cajaMontoTotal" name="fechaHasta" type="text" id="campo_fecha1" size="14" maxlength="10" value="<s:property value='fechaHasta'/>"> 
				...
				<tr> 
                  ...
                  <td align="left" class="label">
					<input class="label" name="mes" type="text" size="15" maxlength="20"> 
                   </td>
                  <td align="left" >A&ntilde;o</td>
                  <td align="left" class="label">
					<input class="label" name="anio" type="text" size="8" maxlength="20"> 
                   </td>
                  <td></td>
                </tr>
  ...
  <tr id="printReady">
    <td colspan="6">
	<s:if test="!cantidadOficiosEmpresaList.isEmpty()">
     ...
     <tr>
      <td width="100%" valign="top">
	 	...
	 	<table cellpadding="1" cellspacing="1" width="80%" align="center" class="tableForm" border="0">
            <tr class="header"> 
              <th width="20%" class="data">Entidad</th>
              <th width="20%" class="data">Oficios Generados </th>
              <th width="20%" class="data">Oficios Pendientes </th>
            </tr>
			<tbody>
			<s:iterator id="item" value="cantidadOficiosEmpresaList">
	            <tr id="f0" class="altRow2"> 
	              <td align="center"><s:property value="entidad"/></td>
	              <td align="center"><s:property value="oficio1"/></td>
	              <td align="center"><s:property value="oficio2"/></td>
	            </tr>
			</s:iterator>
         </table>
	 </td>
