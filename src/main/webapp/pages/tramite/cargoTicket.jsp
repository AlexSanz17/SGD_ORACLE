		...
		<table align="center" style="width:98%;">
			<tr>
				<td colspan="2" style="font-size: 1em; text-align: center;">
					 ORGANISMO SUPERVISOR DE LA INVERSI&Oacute;N EN INFRAESTRUCTURA DE TRANSPORTE DE USO P&Uacute;BLICO
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="font-size: 0.7em;">
					<s:property value="cargo.remitente" />
				</td>
			</tr>
                        
                        <tr>
				<td style="font-size: 0.7em;">
					<strong>Area Destinataria: </strong>
				</td>
				<td style="font-size: 0.7em;">
					<s:property value="cargo.desUnidad" />
				</td>
			</tr>
                        
                        <s:if test="cargo.desCopia!=null && cargo.desCopia!=''" > 
                            <tr>
                                    <td style="font-size: 0.7em;">
                                            <strong>CC: </strong>
                                    </td>
                                    <td style="font-size: 0.7em;">
                                           <s:property value="cargo.desCopia" escape='false'/> 
                                    </td>
                            </tr>
                        </s:if>
			<tr>
			...
			<tr>
				...
				<td style="font-size: 0.7em;">
					<s:property value="cargo.observacion" />
                        ...
                        <tr>
				<td style="font-size: 0.7em;">
					<strong>Nro Folios Totales:</strong>
				</td>
				<td style="font-size: 0.7em;">
					<s:property value="cargo.nroFolios" />
				</td>
			</tr>
				...
				<td style="font-size: 0.7em;">
					<s:property value="cargo.usuarioRegistro" />
				</td>
			</tr>
