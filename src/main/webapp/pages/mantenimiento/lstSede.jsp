...
<%@page import="com.btg.ositran.siged.domain.Sede" %>
<%@ taglib prefix="s" uri="/struts-tags" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <title>Mantenimiento de Sedes</title>
      ...
      <%
         List lstSede = (List) request.getAttribute("lstSede");
      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstSede.size(); i++) {
               objSede = (Sede) lstSede.get(i);
               %>["<%=objSede.getIdsede()%>","<%=objSede.getNombre()%>"],<%
            }
         %>]
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdSede='+i;
            }
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="15%" rowspan="2" align="right">
                    <table  ><tr><td align="right"><a href="<s:url action="doViewSede" />" target="secondFrame"> <img alt="Crear Sede" border="0" src="images/nuevo2.GIF"/></a></td>  <td align="left"><a href="<s:url action="doViewSede" />" target="secondFrame"> Crear Sede</a></td></tr></table>
                  </td>        
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Sedes</td>
                     <td></td>
                  </tr>
               </table>
            </td>
