...
<%@page import="com.btg.ositran.siged.domain.Grupoproceso" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
         List lstGrupoProceso = (List) request.getAttribute("lstGrupoProceso");
      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstGrupoProceso.size(); i++) {
               objGP = (Grupoproceso) lstGrupoProceso.get(i);
               %>["<%=objGP.getIdgrupoproceso()%>","<%=objGP.getNombre()%>","<%=objGP.getFechacreacion()%>"],<%
            }
         %>]
      ...
      <script type="text/javascript">
         ...
         obj.setRowCount(<%=lstGrupoProceso.size()%>);
         ...
         obj.onCellClicked = function(event, col, row)
         {
            ...
            if (id!="")
            {
               A('#e1f3ff',id,'doViewGrupoProceso.action')
            }
            else
            {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdGrupoProceso='+i;
            }
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="14%" rowspan="2" align="right">
                      <table><tr><td align="right">  <a href="<s:url action="doViewGrupoProceso" />" target="secondFrame"><img alt="Crear Grupo de Proceso" border="0" src="images/nuevo2.GIF"/></a> </td>  <td align="left"> <a href="<s:url action="doViewGrupoProceso" />" target="secondFrame">Crear Grupo de Proceso</td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Grupo de Procesos</td>
                     <td></td>
                  </tr>
               </table>
            </td>
