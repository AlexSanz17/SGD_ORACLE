...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <title>Mantenimiento de Listas</title>
      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstLista.size(); i++) {
               objLista = (Lista) lstLista.get(i);
               %>["<%=objLista.getIdlista()%>","<%=objLista.getNombre()%>"],<%
            }
         %>]
      ...
      <script type="text/javascript">
         ...
         obj.onCellClicked = function(event, col, row)
         {
            ...
            if (id!="")
            {
               A('#e1f3ff',id,'doViewLista.action')
            }
            else
            {
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="14%" rowspan="2" align="right">
                      <table><tr><td align="right">  <a href="<s:url action="doViewLista" />" target="secondFrame"><img alt="Crear Lista" border="0" src="images/nuevo2.GIF"/></a> </td>  <td align="left"> <a href="<s:url action="doViewLista" />" target="secondFrame">Crear Lista</td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Listas</td>
                     <td></td>
                  </tr>
               </table>
            </td>
