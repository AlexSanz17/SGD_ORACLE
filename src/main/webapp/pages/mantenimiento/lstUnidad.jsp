...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <title>Mantenimiento de &Aacute;reas</title>
      ...
      <%
    List lstUnidad = (List) request.getAttribute("lstUnidad");
    ...
    for (int i = 0; i < lstUnidad.size(); i++) {
       objUnidad = (Unidad) lstUnidad.get(i);
               %>["<%=objUnidad.getIdunidad()%>","<%=objUnidad.getNombre()%>","<%=(objUnidad.getDependencia() == null)?"":objUnidad.getDependencia().getNombre()%>","<%=objUnidad.getSede().getNombre()%>"],<%
    }
         %>]
      ...
      <script type="text/javascript">
            ...
            obj.setRowCount(<%=lstUnidad.size()%>);
            ...
            obj.onCellClicked = function(event, col, row)
            {
               ...
               if (id!="")
               {
                  A('#e1f3ff',id,'doViewUnidad.action')
               }
               else
               {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdUnidad='+i;
            }
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="34%" rowspan="2" align="right">
                                   ...
                                   <a href="<s:url action="doViewUnidad" />" target="secondFrame"><img alt="Crear Area" border="0" src="images/nuevo2.GIF"/></a>
     
                      </td>  <td align="left"> 
                                                        <a href="<s:url action="doViewUnidad" />" target="secondFrame">Crear Area</a>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Areas</td>
                     <td></td>
                  </tr>
               </table>
            </td>
