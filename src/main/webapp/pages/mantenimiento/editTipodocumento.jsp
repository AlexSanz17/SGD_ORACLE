...
<html>
   <head>
      ...
      <script type="text/javascript">
         ...
         function select() {        
        	...
        	/*var tiponum ="<s:property value='objTipodocumento.tiponumeracion'/>";
			// alert(tiponum);
			var tiponumeracion = null ;
			if(tiponum=="A"){	
				tiponumeracion  = document.getElementById("numeracionA");	
			}else if(tiponum=="M"){
				tiponumeracion  = document.getElementById("numeracionM");
			} 
			                 
			if(tiponumeracion!=null){
			//	a lert("!=null settuing chec" ); 
				tiponumeracion.checked = true ; 
			}*/
         ...
         /*
         function setNumeracion(tipo) {

        	 var tiponumeracion  = document.getElementById("objTipodocumento.tiponumeracion");	
        	 tiponumeracion.value = tipo ;       
   ...
   <body class="barra" topmargin="0" leftmargin="0" rigthmargin="0"  onload="select()">
      <s:form name="frmTipodocumento" action="doSaveTipodocumento" method="POST">
         <table width="100%">
            <tr>
               <td></td>
            ...
            <tr align="center">
               ...
               <td width="99%" colspan="2" align="left">
                  <s:submit src="images/guardar.bmp" type="image" value="Guardar Tipo de Documento" />
               </td>
            </tr>
            <tr>
               <td></td>
                           ...
                           <table width="98%" height="97" align="center" >
                              <tr>
                                 ...
                                 <td colspan="5" height="16" align="left" class="label">
                                    <s:textfield name="objTipodocumento.idtipodocumento" cssStyle="display:none" />
                                 </td>
                              </tr>
                              <tr>
                                 <td></td>
                                 <td height="16" align="left">Nombre</td>
                                 <td colspan="3" align="left" class="label"><s:textfield name="objTipodocumento.nombre" cssClass="cajaMontoTotal" size="25" /></td>
                                 <td></td>
                              </tr>
                              <tr>
                                 <td></td>
                                 <td height="16" align="left">Descripción</td>        
                                 <td colspan="3" align="left" class="label"><s:textarea cssClass="cajaMontoTotal" name="objTipodocumento.descripcion" rows="10" cols="70"/></td>
                                 <td align="left"></td>
                              </tr>
                              <%--<tr>
                                 <td></td>
                                 <td height="16" align="left">Numeracion   </td> 
                                                             
                                 <td colspan="3" align="left" class="label"> Automatica <input type="radio" id="numeracionA" name="objTipodocumento.tiponumeracion"  value="A" >   
                                                                                 Manual <input type="radio" id="numeracionM" name="objTipodocumento.tiponumeracion"  value="M" >  </td>
                                 <td align="left"></td> 
                              </tr>--%>
                              <tr>
                                 <td></td>
