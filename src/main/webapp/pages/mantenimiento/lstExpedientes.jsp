...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
         List lstExpediente = (List) request.getAttribute("lstExpediente");
      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstExpediente.size(); i++) {
               objExpediente = (Expediente) lstExpediente.get(i);
               %>["<%=objExpediente.getIdexpediente()%>","<%=objExpediente.getNroexpediente()%>","<%=objExpediente.getProceso().getNombre()%>","<%=((objExpediente!=null&&objExpediente.getCliente()!=null&&objExpediente.getCliente().getRazonSocial()!=null)?objExpediente.getCliente().getRazonSocial():(objExpediente!=null&&objExpediente.getCliente()!=null?objExpediente.getCliente().getNombres()+" "+objExpediente.getCliente().getApellidoPaterno():" - "))%>","<%=objExpediente.getFechacreacion()%>"],<%
            } 
         %>]
      ...
      <script type="text/javascript">
         ...
         obj.setCellFormat([str, num, str]);
         //	provide cells and headers text
         obj.setCellText(mydata);
         obj.setHeaderText(myColumns);
         //	set number of rows/columns
         obj.setRowCount(<%=lstExpediente.size()%>);
         ...
         obj.onCellClicked = function(event, col, row)
         {
            ...
            if (id!="")
            {
               A('#e1f3ff',id,'doViewExpediente.action')
            }
            else
            {
...
TEXT-INDENT: 0px;
      ...
      <script>
            ...
            function SearchExpSubmit() {
               document.forms["frmFiltrarExpediente"].submit();
            }

            function cleanFields() {
               document.getElementById("objExpediente.nroexpediente").value = "";
               document.getElementById("objExpediente.proceso.nombre").value = "";
               document.getElementById("objExpediente.cliente.nroidentificacion").value = "";
               document.getElementById("objExpediente.cliente.razonsocial").value = "";
               document.getElementById("objExpediente.concesionario.ruc").value = "";
               document.getElementById("objExpediente.concesionario.razonsocial").value = "";
            }
      </script>
   ...
   <body class="barra">
      <table width="100%">
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="16%" rowspan="2" align="right">
                     <!--<a href="<s:url action="doViewExpediente" />" target="secondFrame"><img alt="Crear Expediente" border="0" src="images/botonNuevoExp.gif"/></a>-->
                  </td>
         ...
         <tr>
            <td>
               <s:form name="frmFiltrarExpediente" action="doFiltrarExpediente" method="POST">
                  <table width="100%">
                     <tr>
                        <td height="14" colspan="6">
                           <table width="100%" align="left">
                              <tr>
                                 <td align="left">
                                    <img src="images/buscar.bmp" border="0" onClick="SearchExpSubmit()" alt="Buscar" style="cursor:pointer" />
                                 ...
                                 <td height="100">
                                    <table width="100%" height="97" align="center" >
                                       ...
                                       <tr>
                                          ...
                                          <td colspan="5">
                                             <s:textfield cssClass="cajaMontoTotal" id="objExpediente.nroexpediente" name="objExpediente.nroexpediente" size="20" maxlength="20" />
                                          </td>
                                          <td></td>
                                       </tr>
                                       <tr>
                                          ...
                                          <td colspan="5">
                                             <s:textfield cssClass="cajaMontoTotal" id="objExpediente.proceso.nombre" name="objExpediente.proceso.nombre" size="40" maxlength="60" />
                                          </td>
                                          <td></td>
                                       </tr>
                                       <tr>
                                       ...
                                       <tr>
                                          <td ></td>
                                          <td height="16" align="left" class="titulo">Cliente</td>
                                          <td colspan="5"></td>
                                          <td></td>
                                       </tr>
                                       <tr>
                                          ...
                                          <td colspan="5">
                                             <s:textfield cssClass="cajaMontoTotal" id="objExpediente.cliente.numeroIdentificacion" name="objExpediente.cliente.numeroIdentificacion" size="20" maxlength="80" />
                                          </td>
                                          <td></td>
                                       </tr>
                                       <tr>
                                          <td ></td>
                                          <td height="16" align="left">Raz&oacute;n Social</td>
                                          <td colspan="5">
                                             <s:textfield cssClass="cajaMontoTotal" id="objExpediente.cliente.razonSocial" name="objExpediente.cliente.razonSocial" size="40" maxlength="80" />
                                          </td>
                                          <td></td>
                                       </tr>
                                       <tr>
                                       ...
                                       <tr>
                                          <td ></td>
                                          <td height="16" align="left" class="titulo">Concesionario</td>
                                          <td colspan="5"></td>
                                          <td></td>
                                       </tr>
                                       <tr>
                                          <td ></td>
                                          <td height="16" align="left">R.U.C.</td>
                                          <td colspan="5">
                                             <s:textfield cssClass="cajaMontoTotal" id="objExpediente.concesionario.ruc" name="objExpediente.concesionario.ruc" size="20" maxlength="80" />
                                          </td>
                                          <td></td>
                                       </tr>
                                       <tr>
                                          ...
                                          <td height="16" align="left">Raz&oacute;n Social</td>
                                          <td colspan="5">
                                             <s:textfield cssClass="cajaMontoTotal" id="objExpediente.concesionario.razonSocial" name="objExpediente.concesionario.razonSocial" size="40" maxlength="80" />
                                          </td>
                                          <td></td>
                                       </tr>
                                    </table>
