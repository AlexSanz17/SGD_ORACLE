...
<%@page import="com.btg.ositran.siged.domain.Departamento" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
    List lstDepartamento = (List) request.getAttribute("lstDepartamento");
    ...
    for (int i = 0; i < lstDepartamento.size(); i++) {
       objDepartamento = (Departamento) lstDepartamento.get(i);
               %>["<%=objDepartamento.getIddepartamento()%>","<%=objDepartamento.getNombre()%>"],<%
    }
         %>]
      ...
      <script type="text/javascript">
            ...
            obj.setRowCount(<%=lstDepartamento.size()%>);
            ...
            obj.onCellClicked = function(event, col, row)
            {
               ...
               if (id!="")
               {
                  A('#e1f3ff',id,'doViewDepartamento.action')
               }
               else
               {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdDepartamento='+i;
            }
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="14%" rowspan="2" align="right">
                      <table><tr><td align="right">  <a href="<s:url action="doViewDepartamento" />" target="secondFrame"><img alt="Crear Departamento" border="0" src="images/nuevo2.GIF"/></a> </td>  <td align="left"> <a href="<s:url action="doViewDepartamento" />" target="secondFrame">Crear Departamento</td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Departamentos</td>
                     <td></td>
                  </tr>
               </table>
            </td>
