...
<%@page import="com.btg.ositran.siged.domain.Tipodocumento" %>
<%@ taglib prefix="s" uri="/struts-tags" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <title>Mantenimiento de Tipo de Documentos</title>
      ...
      <%
         List lstTipodocumento = (List) request.getAttribute("lstTipodocumento");
      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstTipodocumento.size(); i++) {
               objTipodocumento = (Tipodocumento) lstTipodocumento.get(i);
               %>["<%=objTipodocumento.getIdtipodocumento()%>","<%=objTipodocumento.getNombre()%>"],<%
            }
         %>]
      ...
      <script type="text/javascript">
         ...
         obj.setRowCount(<%=lstTipodocumento.size()%>);
         ...
         obj.onCellClicked = function(event, col, row)
         {
            ...
            if (id!="")
            {
               A('#e1f3ff',id,'doViewTipodocumento.action')
            }
            else
            {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdTipodocumento='+i;
            }
               ...
               <table width="99%" border="0" align="center">
                  ...
                  <td width="30%" rowspan="2" align="right">
                                       <table>
                                          <tr>
                                             <td align="right">
                                                <a href="<s:url action="doViewTipodocumento" />" target="secondFrame">
                                                   <img alt="Crear Tipo de Documento" border="0" src="images/nuevo2.GIF"/>
                                                   </a>
                                                   </td>
                                                   <td align="left">  <a href="<s:url action="doViewTipodocumento" />" target="secondFrame"> Crear Tipo de Documento </a></td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Tipo de Documentos</td>
                     <td></td>
                  </tr>
               </table>
            </td>
