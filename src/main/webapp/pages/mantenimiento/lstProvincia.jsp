...
<%@page import="com.btg.ositran.siged.domain.Provincia" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
    List lstProvincia = (List) request.getAttribute("lstProvincia");
    ...
    for (int i = 0; i < lstProvincia.size(); i++) {
       objProvincia = (Provincia) lstProvincia.get(i);
               %>["<%=objProvincia.getIdprovincia()%>","<%=objProvincia.getNombre()%>"],<%
    }
         %>]
      ...
      <script type="text/javascript">
            ...
            obj.setRowCount(<%=lstProvincia.size()%>);
            ...
            obj.onCellClicked = function(event, col, row)
            {
               ...
               if (id!="")
               {
                  A('#e1f3ff',id,'doViewProvincia.action')
               }
               else
               {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdProvincia='+i;
            }
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="14%" rowspan="2" align="right">
                      <table><tr><td align="right">  <a href="<s:url action="doViewProvincia" />" target="secondFrame"><img alt="Crear Provincia" border="0" src="images/nuevo2.GIF"/></a> </td>  <td align="left"> <a href="<s:url action="doViewProvincia" />" target="secondFrame">Crear Provincia</td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Provincias</td>
                     <td></td>
                  </tr>
               </table>
            </td>
