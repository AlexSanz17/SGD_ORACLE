...
<%@page import="com.btg.ositran.siged.domain.Perfil" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
         List lstPerfil = (List) request.getAttribute("lstPerfil");
      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstPerfil.size(); i++) {
               objPerfil = (Perfil) lstPerfil.get(i);
               %>["<%=objPerfil.getIdperfil()%>","<%=objPerfil.getNombre()%>"],<%
            }
         %>]
      ...
      <script type="text/javascript">
         ...
         obj.setRowCount(<%=lstPerfil.size()%>);
         ...
         obj.onCellClicked = function(event, col, row)
         {
            ...
            if (id!="")
            {
               A('#e1f3ff',id,'doViewPerfil.action')
            }
            else
            {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdPerfil='+i;
            }
               ...
               <table width="99%" border="0" align="center">
                  ...
                  <td width="34%" rowspan="2" align="right">
                   <table><tr><td align="right"> 
                                       <a href="<s:url action="doViewPerfil" />" target="secondFrame"><img alt="Crear Perfil" border="0" src="images/nuevo2.GIF"/></a>
                      </td>  <td align="left"> 
                                             <a href="<s:url action="doViewPerfil" />" target="secondFrame">Crear Perfil</a>     
              		 </td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Perfiles</td>
                     <td></td>
                  </tr>
               </table>
            </td>
