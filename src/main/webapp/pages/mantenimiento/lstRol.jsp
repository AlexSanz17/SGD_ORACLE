...
<%@page import="com.btg.ositran.siged.domain.Rol" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
         List lstRol = (List) request.getAttribute("lstRol");
      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstRol.size(); i++) {
               objRol = (Rol) lstRol.get(i);
               objRol.setDescripcion((objRol.getDescripcion()==null?"":objRol.getDescripcion()));               
               %>["<%=objRol.getIdrol()%>","<%=objRol.getNombre()%>","<%=objRol.getIdperfil().getNombre()%>","<%=objRol.getDescripcion()%>"],<%
            }
         %>]
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdRol='+i;
            }
               ...
               <table width="99%" border="0" align="center">
                  ...
                  <td width="34%" rowspan="2" align="right">
                                     <table><tr><td align="right"> 
                                        <a href="<s:url action="doViewRol" />" target="secondFrame"><img alt="Crear Rol" border="0" src="images/nuevo2.GIF"/></a>
                   
                      </td>  <td align="left"> 
                                           <a href="<s:url action="doViewRol" />" target="secondFrame">Crear Rol</a>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Roles</td>
                     <td></td>
                  </tr>
               </table>
            </td>
