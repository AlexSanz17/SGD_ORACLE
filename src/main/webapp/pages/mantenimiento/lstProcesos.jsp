...
<%@page import="com.btg.ositran.siged.domain.Proceso" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
         List lstProceso = (List) request.getAttribute("lstPL");
         ...
         var mydata=[<%
			...
			if(lstProceso!=null){
	            for (int i = 0; i < lstProceso.size(); i++) {
	               objP = (Proceso) lstProceso.get(i);
	               %>["<%=objP.getIdproceso()%>","<%=objP.getNombre()%>","<%=objP.getTiempoatencion()%>","<%=objP.getResponsable().getNombres()%> <%=objP.getResponsable().getApellidos()%>"],<%
	            }
			}
         %>]
      ...
      <script type="text/javascript">
         ...
         obj.setCellFormat([num, str, num, str]);
         //	provide cells and headers text
         obj.setCellText(mydata);
         obj.setHeaderText(myColumns);
         //	set number of rows/columns
         obj.setRowCount(<%=lstProceso.size()%>);
         ...
         obj.onCellClicked = function(event, col, row)
         {
            ...
            if (id!="")
            {
               A('#e1f3ff',id,'doViewProceso.action')
            }
            else
            {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdProceso='+i;
            }
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="14%" rowspan="2" align="right">
                      <table><tr><td align="right">  <a href="<s:url action="doViewProceso" />" target="secondFrame"><img alt="Crear Proceso" border="0" src="images/nuevo2.GIF"/></a> </td>  <td align="left"> <a href="<s:url action="doViewProceso" />" target="secondFrame">Crear Proceso</td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Procesos</td>
                     <td></td>
                  </tr>
               </table>
            </td>
