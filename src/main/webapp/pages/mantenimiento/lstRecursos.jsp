...
<%@page import="com.btg.ositran.siged.domain.Recurso" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
         List lstRecurso = (List) request.getAttribute("lstRecurso");
      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstRecurso.size(); i++) {
               objRecurso = (Recurso) lstRecurso.get(i);
               %>["<%=objRecurso.getIdrecurso()%>","<%=objRecurso.getNombre().replace('\n',' ')%>","<%=objRecurso.getCodigo()%>","<%=objRecurso.getActionurl()%>"],<%
            }
         %>]
      ...
      <script type="text/javascript">
         ...
         obj.setRowCount(<%=lstRecurso.size()%>);
         ...
         obj.onCellClicked = function(event, col, row)
         {
            ...
            if (id!="")
            {
               A('#e1f3ff',id,'doViewRecurso.action');
            }
            else
            {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdRecurso='+i;
            }
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="34%" rowspan="2" align="right">
                     ...
                     <a href="<s:url action="doViewRecurso" />" target="secondFrame"><img alt="Crear Recurso" border="0" src="images/nuevo2.GIF"/></a>
                     </td>  <td align="left"> 
                             <a href="<s:url action="doViewRecurso" />" target="secondFrame">Crear Recurso</a>
             		 </td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Recursos</td>
                     <td></td>
                  </tr>
               </table>
            </td>
