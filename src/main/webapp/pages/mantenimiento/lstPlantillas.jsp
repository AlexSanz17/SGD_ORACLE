...
<%@page import="com.btg.ositran.siged.domain.Plantilla" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
      List lstPlantilla = (List) request.getAttribute("lstPlantilla");
      ...
      <script type="text/javascript">
         var myColumns;
         var mydata=[<%
      Plantilla objPlantilla;

      for (int i = 0; i < lstPlantilla.size(); i++) {
         objPlantilla = (Plantilla) lstPlantilla.get(i);

         %>["<%=objPlantilla.getIdplantilla()%>","<%=objPlantilla.getDescripcion()%>","<%= objPlantilla.getFechacreacion() %>"],<%
      }
         %>]
      ...
      <script type="text/javascript">
            ...
            obj.setRowCount(<%=lstPlantilla.size()%>);
            ...
            obj.onCellClicked = function(event, col, row)
            {
               ...
               if (id!="")
               {
                  A('#e1f3ff',id,'doViewPlantilla.action')
               }
               else
               {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdPlantilla='+i;
            }
               ...
               <table width="99%" border="0" align="center">
                  ...
                  <td width="14%" rowspan="2" align="right">
                     <table>
                        <tr>
                           <td align="right">
                              <a href="doViewPlantilla.action" target="secondFrame"><img alt="Crear Plantilla" border="0" src="images/nuevo2.GIF" /></a>
                           </td>
                           <td align="left">
                              <a href="doViewPlantilla.action" target="secondFrame">Crear Plantilla</a>
                           </td>
                        </tr>
                     </table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Plantillas</td>
                     <td></td>
                  </tr>
               </table>
            </td>
