...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <title>Mantenimiento de Usuarios - Compartidos</title>
      ...
      <script type="text/javascript">
         ...
         obj.onCellClicked = function(event, col, row)
         {
            ...
            if (id!="")
            {
               A('#e1f3ff',id,'doViewCompUsuarios.action')
            }
            else
            {
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Compartidos</td>
                     <td></td>
                  </tr>
               </table>
            </td>
