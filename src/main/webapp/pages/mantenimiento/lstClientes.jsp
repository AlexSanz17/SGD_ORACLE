...
<%@page import="com.btg.ositran.siged.domain.Cliente" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <%
      List lstCliente = (List) request.getAttribute("lstCliente");
      ...
      for (int i = 0; i < lstCliente.size(); i++) {
         objCliente = (Cliente) lstCliente.get(i);
         %>["<%=objCliente.getIdCliente()%>","<%=objCliente.getsNombre().replace("\"", "").replace("'", "")%>","<%=objCliente.getTipoIdentificacion().getNombre()%>"],<%
      }
         %>];
      ...
      <script type="text/javascript">
            ...
            obj.setRowCount(<%=lstCliente.size()%>);
            ...
            obj.onCellClicked = function(event, col, row)
            {
               ...
               if (id!="")
               {
                  A('#e1f3ff',id,'doViewCliente.action')
               }
               else
               {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdCliente='+i;
            }
               ...
               <table width="99%" border="0" align="center">
                  ...
                  <td width="14%" rowspan="2" align="right">
                     <table>
                        <tr>
                           <td align="right">
                              <a href="doViewCliente.action" target="secondFrame"><img alt="Crear Cliente" border="0" src="images/nuevo2.GIF" /></a>
                           </td>
                           <td align="left">
                              <a href="doViewCliente.action" target="secondFrame">Crear Cliente</a>
                           </td>
                        </tr>
                     </table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Clientes</td>
                     <td></td>
                  </tr>
               </table>
            </td>
