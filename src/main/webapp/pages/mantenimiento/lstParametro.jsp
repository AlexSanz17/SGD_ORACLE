...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <title>Mantenimiento de Par&aacute;metros</title>
      ...
      <%
    List lstParametro = (List) request.getAttribute("lstParametro");
    ...
    for (int i = 0; i < lstParametro.size(); i++) {
       objParametro = (Parametro) lstParametro.get(i);
               %>["<%=objParametro.getIdparametro()%>","<%=objParametro.getTipo()%>","<%=objParametro.getValor()%>"],<%
    }
         %>]
      ...
      <script type="text/javascript">
            ...
            obj.setRowCount(<%=lstParametro.size()%>);
            ...
            obj.onCellClicked = function(event, col, row)
            {
               ...
               if (id!="")
               {
                  A('#e1f3ff',id,'doViewParametro.action')
               }
               else
               {
      ...
      <script language="JavaScript">
            ...
            function A(c,i,page)
            {
               ...
               parent.frames["secondFrame"].location.href=page+'?iIdParametro='+i;
            }
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="14%" rowspan="2" align="right">
                      <table><tr><td align="right">  <a href="<s:url action="doViewParametro" />" target="secondFrame"><img alt="Crear Parametro" border="0" src="images/nuevo2.GIF"/></a> </td>  <td align="left"> <a href="<s:url action="doViewParametro" />" target="secondFrame">Crear Parametro</td></tr></table>
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mantenimiento de Par&aacute;metros</td>
                     <td></td>
                  </tr>
               </table>
            </td>
