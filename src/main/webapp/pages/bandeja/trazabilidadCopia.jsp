...
<%@page import="com.btg.ositran.siged.domain.Trazabilidadcopia"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.text.SimpleDateFormat"%>
<%
	ArrayList resultadoT =(ArrayList)request.getAttribute("lstTrazabilidadCopia");
	...
	String titulo="";
	if(tipoOrigen.equals('D')) titulo += "Copias enviadas junto al envio del Expediente: "+idOrigen+" el "+fechita.format(((Trazabilidadcopia)resultadoT.get(0)).getFechacreacion());
	else titulo += "Copias de la notificación "+idOrigen;
%>
...
<body>
	...
	<table cellpadding="1" cellspacing="1" class="tableForm" width="90%" align="center">
		<tr class="header">
			...
			<td class="data">Copias</td>
		</tr>
	<%
		if(!resultadoT.isEmpty()){
	    	for(int i=0; i<resultadoT.size(); i++){
	        	Trazabilidadcopia traza = (Trazabilidadcopia)resultadoT.get(i);%>
				<tr  class="altRow2" >
			   	<td align="center"><%=fechita.format(traza.getFechacreacion()) %></td>
			        ...
			        <td align="center">
			        <%if(traza.isConCopias()){%>
			        	<img src="images/xx.gif" border="0" alt="" onClick="verDetalleCopias(<%=traza.getIdtrazabilidadcopia() %>)"/>
			        <%}%>
			        </td>
	      		</tr>
	      	<%}
