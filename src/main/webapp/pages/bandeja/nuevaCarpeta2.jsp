         ...
         <table width="103%">
                           ...
                           <table width="98%" height="50" align="center" >
                              ...
                              <tr>
                                 ...
                                 <td height="24" colspan="4" align="center">
                                    ...
                                    Documento&nbsp;&nbsp;<s:radio name="objCB.aviso" value="1"  list="#{'1':''}" onclick="location.href='nuevaCarpeta2.jsp'"  />
                                 </td>
                                 <td></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 <td ></td>
                                 <td height="24" colspan="4" align="left"><s:textfield name="objCB.parametro1" cssClass="cajaMontoTotal" size="15" /></td>
                                 <td></td>
                              </tr>
                              <tr>
                                 <td ></td>
            ...
            <tr>
               <td colspan="2" align="center">
                  <input type="button" name="busca" value="Aceptar" class="button" onClick="javascript:aceptar()"/>  &nbsp;&nbsp;
