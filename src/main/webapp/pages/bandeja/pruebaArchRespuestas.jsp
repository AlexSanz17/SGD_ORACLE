...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
	<head>
      ...
      <script type="text/javascript">
		...
		<script type="text/javascript" src="js/documentosRespuestas.js"></script>
      
	</head>
	<body class="soria">

		<div id="divTreeDocumentoRespuesta<s:property value='idGrid' />" class="arbol"></div>
		<div id="displayIdDocumentoRespuesta<s:property value='idGrid' />" class="detalleArbol"></div>
		<div id="divTreeDocumentoRespuesta<s:property value='idGrid' />" class="arbol"></div>
		<div id="displayIdDocumentoRespuesta<s:property value='idGrid' />" class="detalleArbol"></div>
		<%--<div id="ocultos">
