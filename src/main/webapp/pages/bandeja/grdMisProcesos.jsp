      ...
      <script type="text/javascript">
         ...
         var mydata=[<%
            ...
            for (int i = 0; i < lstProceso.size(); i++) {
               ...
               datFecha = objP.getFechacreacion();

               if (formatFecha.format(datFecha).equals(formatFecha.format(datHoy))) {
                  sFechaCreacion = formatHora.format(datFecha);
               } else {
                  sFechaCreacion = formatFecha.format(datFecha);
               }

               %>["<%=objP.getIdproceso()%>","<%=objP.getNombre()%>","<%=objP.getTiempoatencion()%>","<%=sFechaCreacion%>"],<%
            }
         %>]
            ...
            <td height="20" colspan="6" width="99%">
               <table width="99%" border="0" align="center">
                  ...
                  <td width="16%" rowspan="2" align="right">
                     <!--<a href="<s:url action="doViewProceso" />" target="secondFrame"><img alt="Crear Proceso" border="0" src="images/botonNuevo.gif"/></a>-->
                  </td>
         ...
         <tr>
            <td height="20"colspan="6" class="titulo" width="99%">
               <table width="70%" border="0" height="20" align="left">
                  <tr>
                     <td bgcolor="#4481B8" width="30%" align="center" class="tituloRojo">Mis Procesos</td>
                     <td></td>
                  </tr>
               </table>
            </td>
