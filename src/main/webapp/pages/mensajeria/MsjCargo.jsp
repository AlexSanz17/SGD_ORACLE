        ...
        <tr> 
          ...
          <table width="98%" height="219" align="center" >
                ...
                <tr> 
                  ...
                  <input name="costenv" type="text" class="cajaMontoTotal" value="<s:property value="ObjCg.costoenvio" />" size="20" disabled > 
                  </td>
                   <td colspan="2" align="left" ></td>
                 <!-- <td align="left" >Grupo</td> -->
                  <td align="left" width="28%" class="label">
                  	<!--<s:if test="Objcargo.grupo.equals('Tarde')">
                  		<input name="grupo" type="radio" value="Mañana" disabled>&nbsp;Mañana&nbsp;
                  	...
                  	<s:else>
                      	...
                      	<input name="grupo" type="radio" value="Tarde" disabled>&nbsp;Tarde
                  	</s:else> -->
                  </td>
                  <td></td>
                </tr>
                <tr> 
                  ...
                  <td align="left" width="13%" class="label"> 
				  <input name="fchentrega" type="text" class="cajaMontoTotal" value="<s:date name="ObjCg.fechaentrega" format="dd/MM/yyyy"/>" size="20" disabled> 
                  </td>
                  <td colspan="2" align="left" ></td>
                ...
                <tr> 
                  ...
                  <td align="left" width="28%" class="label">
				  <input name="fechacargo" type="text" class="cajaMontoTotal" value="<s:date name="ObjCg.fechacargo" format="dd/MM/yyyy"/>" size="20" disabled> 
                  </td>
                  <td></td>
                </tr>
                <tr> 
                  ...
                  <td colspan="3" align="left" width="13%" class="label"> 					
                  <input name="fechadevcargo" type="text" class="cajaMontoTotal" value="<s:date name="ObjCg.fechadevcargo" format="dd/MM/yyyy"/>" size="20" disabled > 
                  </td>
                  <td colspan="1" align="left" >Fecha Devoluci&oacute;n de Documento</td>
                  <td align="left" width="28%" class="label">
                ...
                <tr> 
                  ...
                  <input name="primeravisita" type="text" class="cajaMontoTotal" value="<s:date name="ObjCg.primeravisita" format="dd/MM/yyyy"/>" size="20" disabled></td>
                  <td colspan="3" align="left">Obs                  
                  <input name="obs1" type="text" class="cajaMontoTotal" value="<s:property value="ObjCg.obs1" />" size="59" disabled> 
                  </td>
                  <td></td>
                </tr>
                <tr> 
                  ...
                  <input name="segundavisita" type="text" class="cajaMontoTotal" value="<s:date name="ObjCg.segundavisita" format="dd/MM/yyyy" />" size="20" disabled></td>
                  <td colspan="3" align="left">Obs
                  <input name="obs2" type="text" class="cajaMontoTotal" value="<s:property value="ObjCg.obs2" />" size="59" disabled> 
                  </td>
                  <td></td>
                </tr>
                <tr> 
                  ...
                  <input name="observaciones" type="text" class="cajaMontoTotal" value="<s:property value="ObjCg.observaciones" />" size="90" disabled >
                  </td>
                  <td></td>
                </tr>
                <tr> 
