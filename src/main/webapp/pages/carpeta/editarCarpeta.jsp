   ...
   <script language="JavaScript" type="text/javascript">
     ...
     function guardar () { 
        ...
        if(!esVacio(nombrecarpeta.value)) {
        	 document.forms["frmCarpeta"].action = "/siged/Carpeta_actualizar.action"  ;
     ...
     function eliminar () { 
         ...
         var nombrecarpeta =   document.getElementById("nombrecarpeta");
        if(!esVacio(nombrecarpeta.value)) { 
        	 document.forms["frmCarpeta"].action = "/siged/Carpeta_eliminar.action"  ;
             document.forms["frmCarpeta"].submit();   
        }else{
        	 var mensaje =   document.getElementById("mensaje");
        	 mensaje.innerHTML ="Debe llenar el campo Nombre" ; 
     ...
     function  load (){
     var vacio = "<s:property value="carpeta.vacio" />" ;    
     if(vacio =="N"){
           var tdx =  document.getElementById("eliminar") ;
           		
           tdx.style.display = "none"   
         }
     }
				...
				<table> 
					...
					<td  class="label" >    
                       ...
                       <span id="indicatorProc" style="display:none;"><img src="./images/indicator.gif"/></span>
						...
						<s:textfield id="tipo" name="carpeta.idcarpeta"  cssStyle="display:none"  /> 
                       </td>
					</tr>
		...
		<table   > 
            <tr>
				<td>  
			       ...
			       &nbsp;&nbsp;  <img  onClick="guardar()" src="images/guardar.jpg" border="0" alt="Guardar"/>
				...
				<td  >  <div id="eliminar" >
			   		    <img src="images//eliminar.jpg" border="0" onClick="eliminar();" alt="Eliminar"/>
							 </div>
				</td>
