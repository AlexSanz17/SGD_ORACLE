...
<%@page import="com.btg.ositran.siged.domain.NodoExpReporteAPN3" %>
<%@page import="com.btg.ositran.siged.domain.NodoDocReporteAPN3" %>
...
<html>
	<head>
		...
		<%
			List<NodoExpReporteAPN3> listaReporteAPN3 = (List<NodoExpReporteAPN3>)request.getAttribute("listaReporteAPN3");
			...
			<div id="tablas">
				...
				<table class="tableForm" align="center" border="1">
					<tr class="cabecera">
						...
						<th style="width:100px; border: solid #000000 0.02em;" rowspan="2">Fecha del Expediente</th>
						...
						<%for(int i = 1 ; i<=size; i++){ %>
							<th colspan="5" style="border: solid #000000 0.02em; border-right-width: 0.3em; border-left-width: 0.3em;">Último Documento</th>
						<%} %>
					...
					<tr class="fila">
						...
						for(NodoDocReporteAPN3 doc : fila.getDocumentos()){ %>
							...
							<td class="filaR"><%=doc.getFechaCreacionStr() %></td>
							<td class="filaR"><%=doc.getFechaTransferenciaStr() %></td>
							<td class="filaR" style="border-right-width: 0.3em; "><%=tiempoDias.get(j) + "&nbsp;"%></td>
						<%j++;
						}
						while(j<size){%>
