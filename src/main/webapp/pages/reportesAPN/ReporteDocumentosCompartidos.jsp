...
<html>
	<head>
        <%String usuarioCompartido = (String)request.getAttribute("usuarioCompartido"); %>
		...
		<style type="text/css">
		 ...
		 <%
			...
			List<ItemUF> list = (List<ItemUF>)session.getAttribute("listCompartidos" + usuarioCompartido);
	...
	<%}else{ %>
		No se encontraron resultados de Documentos Compartidos
	<%} %>
	</body>
</html>