...
dojo.addOnLoad(function(){
  	...
  	var defered=service.getArbolNavegador("ND");//service.getArbolDocumentosNavegador();
        ...
        defered.addCallback(function(objJSON){
			...
			autoExpand: true
                ...
                dojo.byId("divTreeDocumentosNavegadorRecibidos").appendChild(arbolito.domNode);
		arbolito.startup();
	});
});
